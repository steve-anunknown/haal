...
module Haal.Models.MQTT.MosquittoNonClean
    ( MosquittoNonCleanInput (..)
    , MosquittoNonCleanOutput (..)
    , mosquittoNonClean
    ) where
...
mosquittoNonClean :: MealyAutomaton Int MosquittoNonCleanInput MosquittoNonCleanOutput
mosquittoNonClean = mkMealyAutomaton delta lambda (Set.fromList [0..11]) 0
  where
