...
module Haal.Models.MQTT.VerneMQInvalid
    ( VerneMQInvalidInput (..)
    , VerneMQInvalidOutput (..)
    , verneMQInvalid
    ) where
...
verneMQInvalid :: MealyAutomaton Int VerneMQInvalidInput VerneMQInvalidOutput
verneMQInvalid = mkMealyAutomaton delta lambda (Set.fromList [0..2]) 0
  where
