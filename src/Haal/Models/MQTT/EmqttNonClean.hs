...
module Haal.Models.MQTT.EmqttNonClean
    ( EmqttNonCleanInput (..)
    , EmqttNonCleanOutput (..)
    , emqttNonClean
    ) where
...
data EmqttNonCleanOutput
    ...
    | Out_C1_ConnectionClosed__c2_SubAck__c2_Pub_my_topic_bye_1
    | Out_C1_ConnectionClosed__c2_UnSubAck
    | Out_C1_PubAck__Empty
    | Out_Empty__c2_SubAck__c2_Pub_my_topic_bye_1
...
emqttNonClean :: MealyAutomaton Int EmqttNonCleanInput EmqttNonCleanOutput
emqttNonClean = mkMealyAutomaton delta lambda (Set.fromList [0..11]) 0
  where
    ...
    lambda 1 In_SubscribeC2QoS1 = Out_C1_ConnectionClosed__c2_SubAck__c2_Pub_my_topic_bye_1
    ...
    lambda 3 In_SubscribeC2QoS1 = Out_Empty__c2_SubAck__c2_Pub_my_topic_bye_1
    ...
    lambda 7 In_ConnectC2 = Out_C1_ConnectionClosed__c2_ConnAck
    lambda 7 In_ConnectC1 = Out_C1_ConnAck__c2_ConnectionClosed
    lambda 7 In_PublishQoS1C1 = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 7 In_SubscribeC2QoS1 = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 7 In_UnSubscribeC2 = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 7 In_DisconnectC2 = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 6 In_ConnectC2 = Out_Empty__c2_ConnAck
    lambda 6 In_ConnectC1 = Out_C1_ConnectionClosed__c2_ConnectionClosed
