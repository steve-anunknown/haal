...
module Haal.Models.DTLS.ScandiumLatestEcdheCertNreq
    ( ScandiumLatestEcdheCertNreqInput (..)
    , ScandiumLatestEcdheCertNreqOutput (..)
    , scandiumLatestEcdheCertNreq
    ) where

import qualified Data.Set as Set
import Haal.Automaton.MealyAutomaton (MealyAutomaton, mkMealyAutomaton)

data ScandiumLatestEcdheCertNreqInput
...
data ScandiumLatestEcdheCertNreqOutput
...
scandiumLatestEcdheCertNreq :: MealyAutomaton Int ScandiumLatestEcdheCertNreqInput ScandiumLatestEcdheCertNreqOutput
scandiumLatestEcdheCertNreq = mkMealyAutomaton delta lambda (Set.fromList [0..16]) 0
  where
    ...
    delta 7 In_ECDH_CLIENT_HELLO = 8
    ...
    delta 9 In_ECDH_CLIENT_HELLO = 10
    ...
    delta 6 In_ECDH_CLIENT_HELLO = 4
    ...
    delta 10 In_CHANGE_CIPHER_SPEC = 16
    ...
    delta 14 In_ECDH_CLIENT_HELLO = 14
    ...
    delta 13 In_ECDH_CLIENT_HELLO = 2
    delta 13 In_ECDH_CLIENT_KEY_EXCHANGE = 2
    delta 13 In_CHANGE_CIPHER_SPEC = 2
    delta 13 In_FINISHED = 14
    delta 13 In_APPLICATION = 13
    delta 13 In_CERTIFICATE = 2
    delta 13 In_EMPTY_CERTIFICATE = 2
    delta 13 In_CERTIFICATE_VERIFY = 2
    ...
    lambda 11 In_ECDH_CLIENT_HELLO = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 11 In_ECDH_CLIENT_KEY_EXCHANGE = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 11 In_CHANGE_CIPHER_SPEC = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 12 In_ECDH_CLIENT_HELLO = Out_Alert_WARNING_NO_RENEGOTIATION
    ...
    lambda 12 In_APPLICATION = Out_APPLICATION
    ...
    lambda 6 In_CERTIFICATE = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 6 In_EMPTY_CERTIFICATE = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 6 In_CERTIFICATE_VERIFY = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 15 In_CHANGE_CIPHER_SPEC = Out_Alert_FATAL_HANDSHAKE_FAILURE
    ...
    lambda 14 In_ECDH_CLIENT_HELLO = Out_Alert_WARNING_NO_RENEGOTIATION
    ...
    lambda 14 In_APPLICATION = Out_APPLICATION
    ...
    lambda 16 In_ECDH_CLIENT_HELLO = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 13 In_ECDH_CLIENT_HELLO = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 13 In_ECDH_CLIENT_KEY_EXCHANGE = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 13 In_CHANGE_CIPHER_SPEC = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 13 In_FINISHED = Out_CHANGE_CIPHER_SPEC_FINISHED_APPLICATION
    lambda 13 In_APPLICATION = Out_TIMEOUT
    lambda 13 In_CERTIFICATE = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 13 In_EMPTY_CERTIFICATE = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 13 In_CERTIFICATE_VERIFY = Out_Alert_FATAL_INTERNAL_ERROR
