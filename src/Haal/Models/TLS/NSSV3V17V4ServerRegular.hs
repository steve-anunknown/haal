...
module Haal.Models.TLS.NSSV3V17V4ServerRegular
    ( NSSV3V17V4ServerRegularInput (..)
    , NSSV3V17V4ServerRegularOutput (..)
...
data NSSV3V17V4ServerRegularOutput
    = Out_Empty
    ...
    | Out_Alert_Fatal__Unexpected_message_Alert_Warning__Close_notify____ConnectionClosed
    | Out_Alert_Fatal__Handshake_failure_Alert_Warning__No_renegotiation_Alert_Warning__Close_notify____ConnectionClosed
