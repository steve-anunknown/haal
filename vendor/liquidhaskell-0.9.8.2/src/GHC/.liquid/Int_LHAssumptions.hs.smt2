...
(declare-fun lq_anf$36$$35$$35$7205759403792803726$35$$35$d2Dk () Int)
...
(declare-fun lit$36$GHC.Int_LHAssumptions () Str)
...
(declare-fun lq_anf$36$$35$$35$7205759403792803724$35$$35$d2Di () Int)
...
(assert (distinct lit$36$GHC.Int_LHAssumptions lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP))
(assert (distinct GHC.Types.True GHC.Types.False))

(assert (distinct GHC.Types.GT GHC.Types.EQ GHC.Types.LT))

(assert (= (strLen lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP) 44))
(assert (= (strLen lit$36$GHC.Int_LHAssumptions) 21))
(push 1)
(push 1)
(pop 1)
(pop 1)
