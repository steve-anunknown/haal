...
(declare-fun lit$36$GHC.CString_LHAssumptions () Str)
...
(assert (distinct lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP lit$36$GHC.CString_LHAssumptions))

(assert (distinct GHC.Types.GT GHC.Types.EQ GHC.Types.LT))

(assert (= (strLen lit$36$GHC.CString_LHAssumptions) 25))
