...
(declare-fun GHC.List.null () Int)
(declare-fun GHC.Real.$36$W$58$$37$ () Int)
(declare-fun GHC.List.length () Int)
...
(declare-fun lq_anf$36$$35$$35$7205759403792804791$35$$35$d2Uv () Int)
(declare-fun GHC.List.zip () Int)
(declare-fun GHC.List.reverse () Int)
(declare-fun GHC.List.errorEmptyList () Int)
(declare-fun lit$36$GHC.List_LHAssumptions () Str)
...
(declare-fun GHC.List.foldr1 () Int)
...
(assert (distinct lit$36$GHC.List_LHAssumptions lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP))

(assert (distinct GHC.Types.GT GHC.Types.EQ GHC.Types.LT))

(assert (= (strLen lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP) 44))
(assert (= (strLen lit$36$GHC.List_LHAssumptions) 22))
(push 1)
(push 1)
(pop 1)
(pop 1)
