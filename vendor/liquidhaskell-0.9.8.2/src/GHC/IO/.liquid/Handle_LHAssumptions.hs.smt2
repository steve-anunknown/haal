...
(declare-fun lq_anf$36$$35$$35$7205759403792805502$35$$35$d35Y () Int)
...
(declare-fun lit$36$GHC.IO.Handle_LHAssumptions () Str)
...
(declare-fun lq_anf$36$$35$$35$7205759403792805500$35$$35$d35W () Int)
...
(assert (distinct lit$36$liquidhaskell$45$0.9.8.2$45$HBZKfLZq3zk3XxT5CzZx6o lit$36$GHC.IO.Handle_LHAssumptions))
...
(assert (distinct GHC.IO.Device.RelativeSeek GHC.IO.Device.AbsoluteSeek GHC.IO.Device.SeekFromEnd))
...
(assert (= (strLen lit$36$GHC.IO.Handle_LHAssumptions) 27))
