...
(declare-fun Data.ByteString.Char8.takeWhile () Int)
(declare-fun Data.ByteString.Char8.index () Int)
(declare-fun Data.ByteString.Char8.findIndex () Int)
(declare-fun GHC.Types.LT () Int)
(declare-fun Data.ByteString.splitAt () Int)
(declare-fun Data.ByteString.Char8.elemIndexEnd () Int)
(declare-fun Data.ByteString.Char8.cons () Int)
(declare-fun Data.ByteString.Char8.elemIndices () Int)
(declare-fun GHC.Int.I64$35$ () Int)
(declare-fun x_Tuple33 () Int)
(declare-fun x_Tuple22 () Int)
(declare-fun lq_anf$36$$35$$35$7205759403792807934$35$$35$d3Jc () Int)
(declare-fun Data.ByteString.Internal.Type.BS () Int)
(declare-fun GHC.Word.W64$35$ () Int)
(declare-fun Data.ByteString.Char8.snoc () Int)
(declare-fun Data.ByteString.Char8.maximum () Int)
(declare-fun Data.ByteString.Char8.foldl1$39$ () Int)
(declare-fun GHC.Int.I32$35$ () Int)
(declare-fun Data.ByteString.Char8.unfoldrN () Int)
...
(declare-fun Data.ByteString.Char8.foldr1 () Int)
(declare-fun Data.ByteString.findIndex () Int)
(declare-fun GHC.IO.Handle.Types.DuplexHandle () Int)
(declare-fun Data.ByteString.ReadNat.readInteger () Int)
(declare-fun Data.ByteString.scanr1 () Int)
(declare-fun Data.ByteString.pack () Int)
(declare-fun Data.ByteString.Char8.zip () Int)
(declare-fun x_Tuple21 () Int)
(declare-fun Data.ByteString.singleton () Int)
(declare-fun Data.ByteString.dropWhile () Int)
(declare-fun lq_anf$36$$35$$35$7205759403792807932$35$$35$d3Ja () Int)
(declare-fun GHC.Word.W8$35$ () Int)
(declare-fun lit$36$Data.ByteString.Char8_LHAssumptions () Str)
(declare-fun len () Int)
(declare-fun Data.ByteString.Char8.intersperse () Int)
(declare-fun Data.ByteString.notElem () Int)
(declare-fun Data.ByteString.takeWhile () Int)
(declare-fun Data.ByteString.Char8.scanl1 () Int)
(declare-fun Data.ByteString.elem () Int)
(declare-fun GHC.Types.TrNameS () Int)
(declare-fun Data.ByteString.Char8.spanEnd () Int)
(declare-fun Data.ByteString.Char8.minimum () Int)
(declare-fun Data.ByteString.Char8.replicate () Int)
...
(declare-fun Data.ByteString.Char8.splitWith () Int)
(declare-fun Data.ByteString.split () Int)
(declare-fun Data.ByteString.cons () Int)
(declare-fun x_Tuple31 () Int)
(declare-fun Data.ByteString.Char8.mapAccumR () Int)
(declare-fun papp2 () Int)
(declare-fun Data.ByteString.isInfixOf () Int)
(declare-fun GHC.Num.Integer.IP () Int)
(declare-fun papp7 () Int)
(declare-fun Data.ByteString.span () Int)
(declare-fun Data.ByteString.Char8.findIndices () Int)
(declare-fun papp1 () Int)
(declare-fun Data.ByteString.Char8.elem () Int)
(declare-fun Data.ByteString.Char8.lines () Int)
(declare-fun Data.ByteString.Char8.singleton () Int)
(declare-fun Data.ByteString.intersperse () Int)
(declare-fun Data.ByteString.Char8.filter () Int)
(declare-fun Data.ByteString.breakSubstring () Int)
(declare-fun GHC.Real.$36$W$58$$37$ () Int)
(declare-fun Data.ByteString.Char8.concatMap () Int)
(declare-fun Data.ByteString.Char8.foldl1 () Int)
(declare-fun Data.ByteString.take () Int)
(declare-fun Data.ByteString.Char8.elemIndex () Int)
...
(declare-fun Data.ByteString.Char8.last () Int)
(declare-fun papp4 () Int)
(declare-fun Data.ByteString.splitWith () Int)
(declare-fun Data.ByteString.Char8.dropWhile () Int)
(declare-fun Data.ByteString.break () Int)
(declare-fun Data.ByteString.Char8.unlines () Int)
...
(declare-fun Data.ByteString.Char8.scanr () Int)
...
(declare-fun Data.ByteString.Char8.find () Int)
(declare-fun Data.ByteString.group () Int)
(declare-fun GHC.Types.$91$$93$ () Int)
(declare-fun Data.ByteString.Char8.scanl () Int)
(declare-fun Data.ByteString.foldr1$39$ () Int)
(declare-fun liquid_internal_this () Int)
(declare-fun Data.ByteString.uncons () Int)
(declare-fun stringlen () Int)
(declare-fun Data.ByteString.Char8.all () Int)
(declare-fun Data.ByteString.Char8.notElem () Int)
...
(declare-fun Data.ByteString.Char8.span () Int)
(declare-fun GHC.Types.EQ () Int)
(declare-fun Data.ByteString.map () Int)
(declare-fun Data.ByteString.Internal.Type.empty () Int)
(declare-fun Data.ByteString.Char8.any () Int)
(declare-fun Data.ByteString.null () Int)
(declare-fun Data.ByteString.Char8.foldr1$39$ () Int)
...
(declare-fun Data.ByteString.Char8.unsnoc () Int)
...
(declare-fun Data.ByteString.Char8.scanr1 () Int)
(declare-fun Data.ByteString.Char8.uncons () Int)
(declare-fun Data.ByteString.ReadInt.readInt () Int)
(declare-fun Data.ByteString.Char8.unpack () Int)
(declare-fun Data.ByteString.concatMap () Int)
(declare-fun Data.ByteString.Char8.words () Int)
(declare-fun Data.ByteString.Lazy.Internal.$36$WChunk () Int)
(declare-fun GHC.Types.True () Bool)
(declare-fun Data.ByteString.Char8.head () Int)
...
(declare-fun Data.ByteString.Char8.split () Int)
(declare-fun Data.ByteString.Char8.unwords () Int)
...
(declare-fun Data.ByteString.Char8.breakEnd () Int)
(declare-fun GHC.Tuple.Prim.$40$$44$$41$ () Int)
(declare-fun GHC.Maybe.Nothing () Int)
(declare-fun Data.ByteString.Char8.unzip () Int)
(declare-fun Data.ByteString.hGet () Int)
(declare-fun tail () Int)
(declare-fun GHC.Types.GT () Int)
(declare-fun Data.ByteString.Char8.zipWith () Int)
(declare-fun Data.ByteString.Char8.pack () Int)
...
(declare-fun Data.ByteString.Char8.mapAccumL () Int)
...
(declare-fun Data.ByteString.Char8.map () Int)
...
(declare-fun Data.ByteString.Char8.groupBy () Int)
(declare-fun Data.ByteString.Char8.break () Int)
(declare-fun GHC.Word.W16$35$ () Int)
(declare-fun Data.ByteString.Char8.count () Int)
...
(assert (distinct lit$36$liquidhaskell$45$0.9.8.2$45$HBZKfLZq3zk3XxT5CzZx6o lit$36$Data.ByteString.Char8_LHAssumptions))

(assert (distinct GHC.Types.GT GHC.Types.EQ GHC.Types.LT))

(assert (= (strLen lit$36$Data.ByteString.Char8_LHAssumptions) 35))
