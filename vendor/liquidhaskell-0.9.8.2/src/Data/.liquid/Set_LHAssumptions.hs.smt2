...
(declare-fun Data.Set.Internal.Tip () (Array Int Bool))
(declare-fun cast_as () Int)
(declare-fun lq_anf$36$$35$$35$7205759403792809321$35$$35$d45z () Int)
...
(declare-fun lq_anf$36$$35$$35$7205759403792809323$35$$35$d45B () Int)
...
(declare-fun Data.Set.Internal.empty () (Array Int Bool))
...
(declare-fun lit$36$Data.Set_LHAssumptions () Str)
...
(assert (distinct lit$36$Data.Set_LHAssumptions lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP))

(assert (distinct GHC.Types.GT GHC.Types.EQ GHC.Types.LT))

(assert (= (strLen lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP) 44))
(assert (= (strLen lit$36$Data.Set_LHAssumptions) 22))
(push 1)
(push 1)
(pop 1)
(pop 1)
