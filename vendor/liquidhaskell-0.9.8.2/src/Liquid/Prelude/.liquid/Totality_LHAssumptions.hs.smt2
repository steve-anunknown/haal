...
(declare-fun lq_anf$36$$35$$35$7205759403792810250$35$$35$d4ky () Int)
...
(declare-fun lit$36$Liquid.Prelude.Totality_LHAssumptions () Str)
(declare-fun GHC.Classes.C$58$IP () Int)
(declare-fun GHC.Enum.C$58$Bounded () Int)
(declare-fun GHC.Types.EQ () Int)
(declare-fun lq_anf$36$$35$$35$7205759403792810252$35$$35$d4kA () Int)
...
(declare-fun Control.Exception.Base.nonExhaustiveGuardsError () Int)
...
(assert (distinct lit$36$Liquid.Prelude.Totality_LHAssumptions lit$36$liquidhaskell$45$0.9.8.2$45$Ga1H4YqYKC8Ef4hKopFcTP))
...
(assert (= (strLen lit$36$Liquid.Prelude.Totality_LHAssumptions) 37))
(push 1)
(push 1)
(pop 1)
(pop 1)
