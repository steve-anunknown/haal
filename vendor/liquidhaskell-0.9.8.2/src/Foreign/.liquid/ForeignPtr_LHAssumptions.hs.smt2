...
(declare-fun lq_anf$36$$35$$35$7205759403792804635$35$$35$d2RZ () Int)
...
(declare-fun lit$36$Foreign.ForeignPtr_LHAssumptions () Str)
...
(assert (distinct lit$36$Foreign.ForeignPtr_LHAssumptions lit$36$liquidhaskell$45$0.9.8.2$45$HBZKfLZq3zk3XxT5CzZx6o))

(assert (distinct GHC.Types.GT GHC.Types.EQ GHC.Types.LT))

(assert (= (strLen lit$36$liquidhaskell$45$0.9.8.2$45$HBZKfLZq3zk3XxT5CzZx6o) 44))
(assert (= (strLen lit$36$Foreign.ForeignPtr_LHAssumptions) 32))
(push 1)
(push 1)
(pop 1)
(pop 1)
