...
module Haal.Models.DTLS.ScandiumLatestEcdheCertReq
    ( ScandiumLatestEcdheCertReqInput (..)
    , ScandiumLatestEcdheCertReqOutput (..)
    , scandiumLatestEcdheCertReq
    ) where

import qualified Data.Set as Set
import Haal.Automaton.MealyAutomaton (MealyAutomaton, mkMealyAutomaton)

data ScandiumLatestEcdheCertReqInput
...
data ScandiumLatestEcdheCertReqOutput
...
scandiumLatestEcdheCertReq :: MealyAutomaton Int ScandiumLatestEcdheCertReqInput ScandiumLatestEcdheCertReqOutput
scandiumLatestEcdheCertReq = mkMealyAutomaton delta lambda (Set.fromList [0..14]) 0
  where
    ...
    delta 5 In_ECDH_CLIENT_KEY_EXCHANGE = 6
    ...
    delta 6 In_CERTIFICATE_VERIFY = 7
    ...
    delta 7 In_CHANGE_CIPHER_SPEC = 9
    ...
    delta 8 In_ECDH_CLIENT_KEY_EXCHANGE = 13
    delta 8 In_CHANGE_CIPHER_SPEC = 14
    delta 8 In_FINISHED = 13
    delta 8 In_APPLICATION = 8
    delta 8 In_CERTIFICATE = 13
    delta 8 In_EMPTY_CERTIFICATE = 13
    delta 8 In_CERTIFICATE_VERIFY = 13
    ...
    lambda 6 In_ECDH_CLIENT_KEY_EXCHANGE = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 9 In_ECDH_CLIENT_HELLO = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 10 In_ECDH_CLIENT_HELLO = Out_Alert_WARNING_NO_RENEGOTIATION
    lambda 10 In_ECDH_CLIENT_KEY_EXCHANGE = Out_TIMEOUT
    lambda 10 In_CHANGE_CIPHER_SPEC = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 11 In_FINISHED = Out_CHANGE_CIPHER_SPEC_FINISHED_APPLICATION
    ...
    lambda 14 In_ECDH_CLIENT_HELLO = Out_Alert_FATAL_INTERNAL_ERROR
    lambda 14 In_ECDH_CLIENT_KEY_EXCHANGE = Out_TIMEOUT
    lambda 14 In_CHANGE_CIPHER_SPEC = Out_Alert_FATAL_INTERNAL_ERROR
    ...
    lambda 13 In_CHANGE_CIPHER_SPEC = Out_Alert_FATAL_HANDSHAKE_FAILURE
