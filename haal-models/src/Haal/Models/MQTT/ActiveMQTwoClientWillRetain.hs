...
module Haal.Models.MQTT.ActiveMQTwoClientWillRetain
    ( ActiveMQTwoClientWillRetainInput (..)
    , ActiveMQTwoClientWillRetainOutput (..)
    , activeMQTwoClientWillRetain
    ) where

import qualified Data.Set as Set
import Haal.Automaton.MealyAutomaton (MealyAutomaton, mkMealyAutomaton)

data ActiveMQTwoClientWillRetainInput
    = In_ConnectC2
...
data ActiveMQTwoClientWillRetainOutput
...
activeMQTwoClientWillRetain :: MealyAutomaton Int ActiveMQTwoClientWillRetainInput ActiveMQTwoClientWillRetainOutput
activeMQTwoClientWillRetain = mkMealyAutomaton delta lambda (Set.fromList [0..17]) 0
  where
    ...
    delta 5 In_ConnectC1WithWill = 9
    delta 5 In_ConnectC1WithWillRetain = 9
    delta 5 In_DeleteRetainedC1 = 5
    delta 5 In_DeleteRetainedC2 = 5
    delta 5 In_SubscribeC2 = 8
    delta 5 In_UnSubScribeC2 = 5
    delta 5 In_DisconnectTCPC1 = 9
    delta 5 In_DisconnectC1 = 1
    delta 9 In_ConnectC2 = 10
    delta 9 In_ConnectC1WithWill = 11
    ...
    delta 11 In_ConnectC2 = 16
    delta 11 In_ConnectC1WithWill = 9
    delta 11 In_ConnectC1WithWillRetain = 9
    delta 11 In_DeleteRetainedC1 = 4
    delta 11 In_DeleteRetainedC2 = 4
    delta 11 In_SubscribeC2 = 14
    delta 11 In_UnSubScribeC2 = 11
    delta 11 In_DisconnectTCPC1 = 9
    delta 11 In_DisconnectC1 = 9
    delta 10 In_ConnectC2 = 9
    delta 10 In_ConnectC1WithWill = 16
    delta 10 In_ConnectC1WithWillRetain = 17
    ...
    delta 14 In_ConnectC2 = 16
    delta 14 In_ConnectC1WithWill = 13
    delta 14 In_ConnectC1WithWillRetain = 13
    delta 14 In_DeleteRetainedC1 = 7
    delta 14 In_DeleteRetainedC2 = 7
    delta 14 In_SubscribeC2 = 14
    delta 14 In_UnSubScribeC2 = 11
    delta 14 In_DisconnectTCPC1 = 13
    delta 14 In_DisconnectC1 = 13
    delta 16 In_ConnectC2 = 11
    delta 16 In_ConnectC1WithWill = 10
    delta 16 In_ConnectC1WithWillRetain = 10
    delta 16 In_DeleteRetainedC1 = 2
    ...
    delta 15 In_ConnectC2 = 17
    delta 15 In_ConnectC1WithWill = 13
    delta 15 In_ConnectC1WithWillRetain = 13
    delta 15 In_DeleteRetainedC1 = 8
    delta 15 In_DeleteRetainedC2 = 8
    delta 15 In_SubscribeC2 = 15
    delta 15 In_UnSubScribeC2 = 12
    delta 15 In_DisconnectTCPC1 = 13
    delta 15 In_DisconnectC1 = 13
    delta 17 In_ConnectC2 = 12
    delta 17 In_ConnectC1WithWill = 10
    delta 17 In_ConnectC1WithWillRetain = 10
    delta 17 In_DeleteRetainedC1 = 3
    delta 17 In_DeleteRetainedC2 = 17
    delta 17 In_SubscribeC2 = 17
    delta 17 In_UnSubScribeC2 = 17
    delta 17 In_DisconnectTCPC1 = 10
    delta 17 In_DisconnectC1 = 10
    delta 12 In_ConnectC2 = 17
    delta 12 In_ConnectC1WithWill = 9
    delta 12 In_ConnectC1WithWillRetain = 9
    delta 12 In_DeleteRetainedC1 = 5
    delta 12 In_DeleteRetainedC2 = 5
    delta 12 In_SubscribeC2 = 15
    delta 12 In_UnSubScribeC2 = 12
    delta 12 In_DisconnectTCPC1 = 9
    delta 12 In_DisconnectC1 = 9
    ...
    lambda 13 In_DeleteRetainedC2 = Out_C1_ConnectionClosed__Pub_c2_my_topic____c2_PubAck
    lambda 13 In_SubscribeC2 = Out_C1_ConnectionClosed__c2_SubAck
    ...
    lambda 14 In_ConnectC1WithWill = Out_C1_ConnectionClosed__Pub_c2_my_topic_bye
    lambda 14 In_ConnectC1WithWillRetain = Out_C1_ConnectionClosed__Pub_c2_my_topic_bye
    lambda 14 In_DeleteRetainedC1 = Out_C1_PubAck__Pub_c2_my_topic
    lambda 14 In_DeleteRetainedC2 = Out_Empty__Pub_c2_my_topic____c2_PubAck
    lambda 14 In_SubscribeC2 = Out_Empty__c2_SubAck
    lambda 14 In_UnSubScribeC2 = Out_Empty__c2_UnSubAck
    lambda 14 In_DisconnectTCPC1 = Out_C1_ConnectionClosed__Pub_c2_my_topic_bye
    ...
    lambda 15 In_DeleteRetainedC1 = Out_C1_PubAck__Pub_c2_my_topic
    lambda 15 In_DeleteRetainedC2 = Out_Empty__Pub_c2_my_topic____c2_PubAck
    lambda 15 In_SubscribeC2 = Out_Empty__c2_SubAck
    ...
    lambda 17 In_ConnectC2 = Out_Empty__c2_ConnAck
    lambda 17 In_ConnectC1WithWill = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 17 In_ConnectC1WithWillRetain = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 17 In_DeleteRetainedC1 = Out_C1_PubAck__c2_ConnectionClosed
    lambda 17 In_DeleteRetainedC2 = Out_Empty__c2_ConnectionClosed
    lambda 17 In_SubscribeC2 = Out_Empty__c2_ConnectionClosed
    lambda 17 In_UnSubScribeC2 = Out_Empty__c2_ConnectionClosed
    lambda 17 In_DisconnectTCPC1 = Out_C1_ConnectionClosed__c2_ConnectionClosed
    lambda 17 In_DisconnectC1 = Out_C1_ConnectionClosed__c2_ConnectionClosed
