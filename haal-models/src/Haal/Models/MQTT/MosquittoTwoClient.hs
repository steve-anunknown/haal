...
module Haal.Models.MQTT.MosquittoTwoClient
    ( MosquittoTwoClientInput (..)
    , MosquittoTwoClientOutput (..)
    , mosquittoTwoClient
    ) where
...
mosquittoTwoClient :: MealyAutomaton Int MosquittoTwoClientInput MosquittoTwoClientOutput
mosquittoTwoClient = mkMealyAutomaton delta lambda (Set.fromList [0..15]) 0
  where
    ...
    lambda 7 In_SubscribeC2 = Out_C1_ConnectionClosed_eof_stream___c2_SubAck
    ...
    lambda 9 In_SubscribeC1 = Out_C1_SubAck__Empty
    ...
    lambda 6 In_SubscribeC1 = Out_C1_SubAck__c2_ConnectionClosed_eof_stream
