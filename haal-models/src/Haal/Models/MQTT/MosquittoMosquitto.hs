...
module Haal.Models.MQTT.MosquittoMosquitto
    ( MosquittoMosquittoInput (..)
    , MosquittoMosquittoOutput (..)
    , mosquittoMosquitto
    ) where
...
mosquittoMosquitto :: MealyAutomaton Int MosquittoMosquittoInput MosquittoMosquittoOutput
mosquittoMosquitto = mkMealyAutomaton delta lambda (Set.fromList [0..2]) 0
  where
