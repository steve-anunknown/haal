...
module Haal.Models.MQTT.VerneMQTwoClient
    ( VerneMQTwoClientInput (..)
    , VerneMQTwoClientOutput (..)
    , verneMQTwoClient
    ) where
...
data VerneMQTwoClientOutput
    ...
    | Out_C1_ConnectionClosed_client_close___c2_ConnectionClosed_conn_reset
    ...
    | Out_C1_ConnectionClosed_conn_reset___c2_ConnectionClosed_client_close
    ...
    | Out_Empty__c2_ConnectionClosed_conn_reset
    | Out_C1_ConnectionClosed_conn_reset___Empty
    | Out_Empty__Empty
    ...
    | Out_C1_ConnectionClosed_conn_reset___c2_ConnAck
    | Out_C1_ConnectionClosed_conn_reset___c2_ConnectionClosed_conn_reset
    | Out_C1_ConnectionClosed_conn_reset___c2_SubAck
    | Out_C1_ConnectionClosed_conn_reset___c2_UnSubAck
    | Out_C1_ConnAck__c2_ConnectionClosed_conn_reset
    | Out_C1_ConnectionClosed_client_close___Pub_c2_my_topic_messageQos0
    | Out_C1_ConnectionClosed_conn_reset___Pub_c2_my_topic_bye
    ...
    | Out_C1_PubAck__c2_ConnectionClosed_conn_reset
    | Out_C1_SubAck__c2_ConnectionClosed_conn_reset
    | Out_C1_UnSubAck__c2_ConnectionClosed_conn_reset
    | Out_Pub_c1_my_topic_messageQos0___Empty
    | Out_Pub_c1_my_topic_messageQos1___c1_PubAck__Empty
    | Out_Pub_c1_my_topic_messageQos1___c1_PubAck__c2_ConnectionClosed_conn_reset
    ...
    | Out_C1_ConnectionClosed_conn_reset___Pub_c2_my_topic_messageQos0
